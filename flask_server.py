...
if __name__ == '__main__':
    ...
    try:
        ...
        print('model loaded')
        p_labeler = joblib.load(app.root_path + '/models/labeler.pkl')
        print('model loaded')
        p_model_catalog = joblib.load(app.root_path + '/models/model_catalog.pkl')
        print('model loaded')
        p_log_model_1 = joblib.load(app.root_path + '/models/log_model_1.pkl')
        print('model loaded')
        p_log_model_2 = joblib.load(app.root_path + '/models/log_model_2.pkl')
        print('model loaded')
        p_log_model_3 = joblib.load(app.root_path + '/models/log_model_3.pkl')
        print('model loaded')
        p_log_model_4 = joblib.load(app.root_path + '/models/log_model_4.pkl')
        print('model loaded')
